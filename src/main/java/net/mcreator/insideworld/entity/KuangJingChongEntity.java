...
public class KuangJingChongEntity extends Monster {
	public KuangJingChongEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InsideWorldModEntities.KUANG_JING_CHONG.get(), world);
	}

	public KuangJingChongEntity(EntityType<KuangJingChongEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(InsideWorldModItems.NING_XIAO.get()));
	}
