...
import tms.chabry.auroria.world.features.plants.AFeature;
...
public class AuroriaModFeatures {
	...
	public static final RegistryObject<Feature<?>> MAGICGRASS = REGISTRY.register("magicgrass", AFeature::feature);
}
