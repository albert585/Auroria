...
public class OreinEntity extends Monster {
	public OreinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AuroriaModEntities.OREIN.get(), world);
	}

	public OreinEntity(EntityType<OreinEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("矿晶虫"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(AuroriaModItems.GEL.get()));
	}
