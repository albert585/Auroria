...
@Mod("auroria")
public class AuroriaMod {
	public static final Logger LOGGER = LogManager.getLogger(AuroriaMod.class);
	...
	public AuroriaMod() {
		...
		AuroriaModItems.REGISTRY.register(bus);
		AuroriaModEntities.REGISTRY.register(bus);
